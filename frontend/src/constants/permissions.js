export const PERMISSIONS = {
    ...
    // Form Management
    FORMS_MANAGE: "forms.manage", // Simplification if no sub-actions

    // Ad Competition
    COMPETITION_ADD: "competition.add",
    COMPETITION_EDIT: "competition.edit",
    COMPETITION_TESTIMONIALS: "competition.testimonials", // Group if needed
    COMPETITION_CANDIDATES: "competition.candidates", // Group if needed
