      ...
      >
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="bg-[#FFBD3D] text-black px-12 py-2 rounded font-medium shadow-sm transition-opacity hover:opacity-90"
          >
            Save
          </button>
          ...
          <button
            type="button"
            className="bg-white border border-gray-300 text-black px-12 py-2 rounded font-medium shadow-sm transition-colors hover:bg-gray-50"
          >
            Edit
          </button>
        </div>
