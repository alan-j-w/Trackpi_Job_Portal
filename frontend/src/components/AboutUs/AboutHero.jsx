...
const AboutHero = () => {
    return (
        <section className="max-w-7xl mx-auto px-6 pt-10 md:pt-40 lg:pt-52 pb-10 grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6">
                <h2 className="text-[40px] md:text-[64px] font-bold leading-tight">
                    About <span className="text-[#FFB300]">Trackpi</span>
                </h2>
