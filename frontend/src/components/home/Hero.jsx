    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-12">
        ...
        <div className="flex-1 space-y-6 w-full text-center lg:text-left">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0 font-['Montserrat']">
          ...
          <div className="pt-4 flex flex-row items-center justify-center lg:justify-start gap-2 min-w-0 flex-wrap sm:flex-nowrap">
        ...
        <div className="flex-1 w-full grid grid-cols-12 gap-4 lg:gap-6">
          ...
          <div className="col-span-12 sm:col-span-7 flex flex-col gap-4 lg:gap-6">
            ...
            {/* 1. Meeting Photo */}
            <div className="h-[200px] sm:h-[240px] rounded-tl-[60px] overflow-hidden shadow-lg border border-gray-100 bg-white group/img">
              <img
                src={meeting}
          ...
          <div className="col-span-12 sm:col-span-5 flex flex-col gap-4 lg:gap-6">
            ...
            {/* 3. Lady Photo */}
            <div className="h-[260px] sm:h-[340px] relative rounded-tr-[60px] shadow-lg border border-gray-100 overflow-hidden bg-gradient-to-b from-[#A4B3BD] to-[#E8E6E6] group/img">
              <img
                src={lady}
            ...
            {/* 4. Link Text Card */}
            <div className="h-[130px] sm:h-[160px] rounded-br-[60px] bg-[#F3F5F7] p-5 lg:p-8 flex flex-col justify-center relative overflow-hidden group/card shadow-sm border border-gray-100 transition-all hover:shadow-md hover:bg-gray-100">
